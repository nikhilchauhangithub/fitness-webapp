...
<strong class="text-uppercase opacity-90 font-12">Enjoy the glow of good Health</strong>
...
<?php
$recommed_slide_query=mysqli_query($cn,"select * from hw_slider");
while($row_slider=mysqli_fetch_array($recommed_slide_query))
{
    ?>
    <div class="splide__slide">
<a href="https://e-trainerapp.in/hw-sub-category.php?main_cat_id=<?php echo $row_slider['slider_id'];?>" class="mx-3">
<div class="card card-style" style="background-image:url(<?php echo $row_slider['image_url'];?>);" data-card-height="250">
...
<div class="row">
    <?php
$instant_slide_query=mysqli_query($cn,"select * from hw_instant_workout");
while($row_instant_slider=mysqli_fetch_array($instant_slide_query))
{
    ?>
<div class="col-6 pe-2">
<a href="https://e-trainerapp.in/hw-instant-workout-sub.php?workout_id=<?php echo $row_instant_slider['workout_id'];?>" class="card card-style mx-0 mb-3">
...
location.href="https://e-trainerapp.in/hw-home-menu.php";
},
error: function(){} 	        
});
}));
