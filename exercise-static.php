...
$finalpok_query=mysqli_query($cn,"select * from  ins_wor_all where ins_wor_id='$ins_wor_id'");
...
<?php
    ...
    $days=$_GET['days'];
    $ip=0;
$finalpo_query=mysqli_query($cn,"select * from master_plan where Plan_id='$parent_cat' and Days='$days'");
...
<p>
Don't forget to finish these courses to get your certifications. You're almost there.
</p> -->
...
<a href="#" class="d-block font-10 color-theme"><span class="color-theme opacity-70 font-800">Rep</span> <span class="font-600 opacity-50"><?php echo $row_print_slider['Reps_Goal_Total'];?></span>
<a href="#" class="d-block font-10 color-theme"><i class="fa-solid fa-glass-water color-theme opacity-70 font-800"></i> <span class="font-600 opacity-70 color-blue-dark">Stay Hydrated</span></a>
</div>
</div>
